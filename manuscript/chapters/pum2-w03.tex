...
\begin{figure}[htbp]
    \includegraphics[width=1.0\textwidth]{fig/pum2-w03-job_cancel.png}
    \caption{Ustrukturyzowana współbieżność.}
    \label{fig:figura-job-cancel}
\end{figure}
...
\begin{figure}[htbp]
    \includegraphics[width=1.0\textwidth]{fig/pum2-w03-deferred.png}
    \caption{Odbieranie wyników.}
    \label{fig:figura-deferred}
\end{figure}
